#pragma checksum "D:\ProjectSharp\TestTaskUWP\Views\HistoryTransaction.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "CBF003244739A67F44B909EBCA35E6BA"
//------------------------------------------------------------------------------
// <auto-generated>
            ...
            IHistoryTransaction_Bindings
        {
            ...
            private void Update_(global::TestTaskUWP.Models.Transaction obj, int phase)
            {
                if (obj != null)
                {
                    ...
                    {
                        this.Update_CommentTransaction(obj.CommentTransaction, phase);
                    }
                }
            }
            private void Update_CommentTransaction(global::System.String obj, int phase)
            {
            ...
            IHistoryTransaction_Bindings
        {
            ...
            private void Update_(global::TestTaskUWP.Models.Transaction obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_CategoryTransaction(obj.CategoryTransaction, phase);
                    }
                }
            }
            private void Update_CategoryTransaction(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            IHistoryTransaction_Bindings
        {
            ...
            private void Update_(global::TestTaskUWP.Models.Transaction obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_TypeTransaction(obj.TypeTransaction, phase);
                    }
                }
            }
            private void Update_TypeTransaction(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            IHistoryTransaction_Bindings
        {
            ...
            private void Update_(global::TestTaskUWP.Models.Transaction obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_AmountTransaction(obj.AmountTransaction, phase);
                    }
                }
            }
            private void Update_AmountTransaction(global::System.Int32 obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            IHistoryTransaction_Bindings
        {
            ...
            private void Update_(global::TestTaskUWP.Models.Transaction obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_DateAndTimeTransaction(obj.DateAndTimeTransaction, phase);
                    }
                }
            }
            private void Update_DateAndTimeTransaction(global::System.DateTime obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
