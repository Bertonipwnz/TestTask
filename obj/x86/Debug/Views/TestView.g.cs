...
namespace TestTaskUWP.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            ITestView_Bindings
        {
            ...
            private void Update_Transaction(global::TestTaskUWP.ViewModels.TransactionVM obj, int phase)
            {
                ...
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_Transaction_Date_and_Time_Transaction(obj.Date_and_Time_Transaction, phase);
                    }
                }
            }
            ...
            private void Update_Transaction_Date_and_Time_Transaction(global::System.DateTime obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (bindings != null)
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                ...
                                bindings.Update_Transaction_Date_and_Time_Transaction(obj.Date_and_Time_Transaction, DATA_CHANGED);
                            }
                        }
                        else
                        {
                            switch (propName)
                            {
                                ...
                                case "Date_and_Time_Transaction":
                                {
                                    if (obj != null)
                                    {
                                        bindings.Update_Transaction_Date_and_Time_Transaction(obj.Date_and_Time_Transaction, DATA_CHANGED);
